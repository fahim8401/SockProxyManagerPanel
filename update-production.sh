...
# Update Production Server with Complete Admin Panel
# Run this on your production server: bash update-production.sh
...
echo "🔄 Updating production server with comprehensive admin panel..."
...
# Update server with comprehensive version
cd $INSTALL_DIR

# Create the comprehensive server.js with full admin panel
...
<body>
    <div class="container">
        ...
        <div class="status">✅ System Online - Full Version</div>
        ...
        <div class="credentials">
            ...
            <p><strong>Endpoint:</strong> 103.7.4.183:1080</p>
        </div>
        
        <p style="margin-top: 30px; opacity: 0.8;">
            Professional SAAS Platform v2.0 - Full Version Active
        </p>
    </div>
</body>
</html>`;
...
app.get('/api/health', (req, res) => {
    res.json({
        status: 'OK',
        message: 'Xray SOCKS5 Management System - Full Version',
        version: '2.0.0',
...
async function startServer() {
    try {
        ...
        app.listen(PORT, '0.0.0.0', () => {
            console.log('🚀 Xray SOCKS5 Management System Started - FULL VERSION');
            console.log(`🌐 Web Interface: http://0.0.0.0:${PORT}`);
            console.log(`🔐 Admin Panel: http://0.0.0.0:${PORT}/admin`);
            console.log('🔗 SOCKS5 Proxy: 103.7.4.183:1080');
...
echo "✅ Server updated with comprehensive version"

# Start service
systemctl start $SERVICE_NAME

echo "🚀 Production server updated successfully!"
echo "🌐 Access: http://103.7.4.183:3000/admin"
